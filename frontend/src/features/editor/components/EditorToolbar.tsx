...
export function CanvasZoomControls({disabled = false}: {disabled?: boolean}) {
  ...
  return <div className="absolute left-3.5 top-3.5 z-20 flex items-center gap-1 rounded-xl border border-line-strong bg-popover p-1 shadow-panel backdrop-blur-xl" aria-label="画布缩放">
