...
export function RangeControl({value, min, max, step = 1, onChange, ariaLabel}: RangeControlProps) {
  ...
  return <input className="mt-2 h-[22px] w-full cursor-pointer appearance-none bg-transparent [&::-moz-range-progress]:h-1 [&::-moz-range-progress]:rounded-full [&::-moz-range-progress]:bg-accent [&::-moz-range-thumb]:size-3.5 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:border-[3px] [&::-moz-range-thumb]:border-accent-strong [&::-moz-range-thumb]:bg-accent-soft-ink [&::-moz-range-thumb]:shadow-[0_2px_8px_rgb(0_0_0/.53)] [&::-moz-range-track]:h-1 [&::-moz-range-track]:rounded-full [&::-moz-range-track]:bg-line [&::-webkit-slider-runnable-track]:h-1 [&::-webkit-slider-runnable-track]:rounded-full [&::-webkit-slider-runnable-track]:[background:linear-gradient(90deg,var(--color-accent)_0_var(--range-progress),var(--color-line)_var(--range-progress)_100%)] [&::-webkit-slider-thumb]:mt-[-5px] [&::-webkit-slider-thumb]:size-3.5 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:border-[3px] [&::-webkit-slider-thumb]:border-accent-strong [&::-webkit-slider-thumb]:bg-accent-soft-ink [&::-webkit-slider-thumb]:shadow-[0_2px_8px_rgb(0_0_0/.53)] hover:[&::-webkit-slider-thumb]:scale-[1.13] hover:[&::-webkit-slider-thumb]:shadow-[0_0_0_4px_rgb(16_211_163/.12),0_2px_8px_rgb(0_0_0/.53)]" type="range" min={min} max={max} step={step} value={value} aria-label={ariaLabel} style={{'--range-progress': `${progress}%`} as CSSProperties} onChange={event => onChange(Number(event.target.value))}/>
}
